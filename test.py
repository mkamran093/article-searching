...
async def main():
    ...
    query = '"Unlicensed" "Cannabis" "Revenue" "Europe"'
    instructions = "Extract a paragraph containing relevant data matching this query. The paragraph should contain information related to unlicensed cannabis revenue in Europe."
    #add timeframe
    ...
    for link in all_links:
        ...
        if content:
            relevant_paragraph = await extract_relevant_paragraph(content, query, instructions)
